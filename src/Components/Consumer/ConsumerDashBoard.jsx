    ...
    <div>
        ...
        <div className="Con-cont">
            ...
            <div className="sec2" style={{display:"flex"}}>
                ...
                <p style={{fontSize:"30px"}} >This section allows you to view all the items donated by donors. Each item includes details such as type, quantity, and condition so you can make informed decisions before requesting. You can scroll through the list and choose items that are most useful for you.</p>
            </div>
            ...
            <div className="sec2" style={{display:"flex"}}>
                ...
                <p style={{fontSize:"30px"}}>When you request an item, the donor gets notified. Once approved, you can coordinate with the donor to receive the item. All your requested items are shown here with real-time status updates, so you always know the progress.</p>
                </div>
